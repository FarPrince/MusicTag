...
/// plain text a TextBox actually holds. Empty/whitespace text converts back to null (clears the
/// field); unparsable text is rejected via <see cref="BindingOperations.DoNothing"/> so a bad
/// keystroke doesn't silently null out the field.
/// </summary>
